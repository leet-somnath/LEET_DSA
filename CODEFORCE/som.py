...
# Car brand names
#lst = ["Toyota", "Ford", "Chevrolet", "Honda", "Mercedes-Benz", "BMW", "Audi", "Lexus", "Volkswagen", "Tesla","Hyundai", "Nissan", "Volvo", "Mazda", "Subaru", "Kia", "Jaguar", "Land Rover", "Porsche", "Ferrari","Maserati", "Bugatti", "Jeep", "Chrysler", "Dodge", "Ram", "Buick", "Cadillac", "Lincoln", "GMC"]
